...
{
	if (key == RIGHT)
		player_keys(((t_all *)temp)->player, FALSE);
	else if (key == LEFT)
		player_keys(((t_all *)temp)->player, FALSE);
	else if (key == UP)
		player_keys(((t_all *)temp)->player, FALSE);
...
int				key_press(int key, void *temp)
{
	if (key == ESC)
		...
		player_keys(((t_all *)temp)->player, RIGHT);
	else if (key == LEFT)
		player_keys(((t_all *)temp)->player, LEFT);
	else if (key == UP)
		player_keys(((t_all *)temp)->player, UP);
	else if (key == DOWN)
		player_keys(((t_all *)temp)->player, DOWN);
	return (0);
}
